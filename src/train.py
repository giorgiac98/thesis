...
from utils import env_maker, prepare_networks_and_policy, training_loop, MyWandbLogger


@hydra.main(version_base=None, config_path="../configs", config_name="train")
def main(cfg: DictConfig):
    if cfg.data.problem == 'ems':
        inst = cfg.data.other.instances
        exp_name = f'{cfg.model.policy}-{"-".join(map(str, inst))}'
    ...
    wandb_params = dict(config=wandb_cfg,
                        ...
                        tags=[cfg.data.problem, cfg.model.policy, '2732'])
